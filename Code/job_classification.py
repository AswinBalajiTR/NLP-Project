...
JOBS_FILE = "jobs.csv"
GMAIL_FILE = "gmail_subject_body_date.xlsx"
OUTPUT_FILE = "gmail_subject_body_date_labeled.xlsx"
...
CORE_JOB_KEYWORDS = [
    ...
    "application status",
    "thank you for applying","thank you for taking assessment",
    ...
    "video interview",
    "offer","job offer",
    "not moving forward","regret to inform",
